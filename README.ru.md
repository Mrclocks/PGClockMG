> 🚀 **`v4.0.3`** — Раздельная установка мастера и панели бэкапа + усиление безопасности  
...
С **v4.0.3** они ставятся и удаляются **независимо**. Удаление мастера после restore **не** трогает панель бэкапа.
