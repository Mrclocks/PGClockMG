> 🚀 **`v4.0.2`** — Раздельная установка мастера и панели бэкапа + усиление безопасности  
...
С **v4.0.2** они ставятся и удаляются **независимо**. Удаление мастера после restore **не** трогает панель бэкапа.
