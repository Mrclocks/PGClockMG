...
> ⚠️ **نسخه بتا (`v1.1beta`)** — الان عمومی شده، ولی هنوز در مرحله آزمایش است. ممکن است باگ داشته باشد؛ لطفاً با احتیاط استفاده کنید.
...
`v1.1beta` · پورت `7000` · فارسی / English / Русский
