...
> 🚀 **`v4.0.2`** — نصب جداگانه ویزارد و پنل بکاپ + سخت‌گیری امنیتی  
...
از `v4.0.2` این دو **جدا نصب و حذف می‌شوند**. پاک کردن ویزارد بعد از ریستور، بکاپر را حذف نمی‌کند.
...
- ⏰ زمان‌بندی روزانه + نگه‌داشت N فایل
- 📱 تلگرام (+ پروکسی) با تگ متصل/قطع
- 🌊 استریم به ویزارد مقصد → تأیید دستی → ریستور
