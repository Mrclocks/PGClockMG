...
آدرس پنل بعد از نصب: `http://SERVER_IP:PORT`  
پورت پیش‌فرض: `7000`
...
| گزینه | کار |
|-------|-----|
| ۱ · Install / update | پورت وب‌پنل را می‌پرسد (Enter یعنی همان `7000`)، نصب را کامل می‌کند و در آخر آدرس ورود را می‌دهد |
...
۵. در پایان نصب، اسکریپت آدرس وب‌پنل را نشان می‌دهد. وارد وب‌پنل شوید و مراحل را قدم‌به‌قدم جلو ببرید.  G ریستور یا مهاجرت را انجام دهید
