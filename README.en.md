> 🚀 **`v4.0.2`** — Separate wizard & backup installs + security hardening  
...
From **v4.0.2** they install and uninstall **independently**. Removing the wizard after restore does **not** remove the backup panel.
