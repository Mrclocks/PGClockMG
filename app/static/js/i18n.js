...
const I18N = {
  en: {
    ...
    step3: {
      ...
      crossDbWarning: 'Cross-DB: {source} → {target}. SQLite uses native copy; MySQL/PostgreSQL use hybrid migration.',
  ...
  fa: {
    ...
    step3: {
      ...
      crossDbWarning: 'مهاجرت بین DB: {source} → {target}. SQLite بومی؛ MySQL/PostgreSQL ترکیبی.',
  ...
  ru: {
    ...
    step3: {
      ...
      crossDbWarning: 'Миграция БД: {source} → {target}. SQLite — нативно; MySQL/PostgreSQL — гибрид.',
