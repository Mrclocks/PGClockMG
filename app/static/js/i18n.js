...
const I18N = {
  en: {
    ...
    step3: {
      ...
      crossDbWarning: 'Cross-DB: {source} → {target}. Universal engine — any source to any target.',
  ...
  fa: {
    ...
    step3: {
      ...
      crossDbWarning: 'مهاجرت DB: {source} → {target}. موتور یکپارچه — هر مبدأ به هر مقصد.',
  ...
  ru: {
    ...
    step3: {
      ...
      crossDbWarning: 'Миграция БД: {source} → {target}. Универсальный движок.',
