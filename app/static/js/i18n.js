...
const I18N = {
  ...
  fa: {
    ...
    welcome: {
      ...
      betaWarning: '',
      backupWarning: 'این یک نسخه بتا است. برای پیشگیری از مشکلات احتمالی، حتماً از دیتابیس و فایل‌های مهم خود بکاپ بگیرید.',
  ...
  ru: {
    ...
    welcome: {
      ...
      betaWarning: '',
      backupWarning: 'Это бета-версия. Для предотвращения возможных проблем обязательно сделайте бэкап базы данных и важных файлов.',
