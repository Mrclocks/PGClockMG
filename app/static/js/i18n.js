...
const I18N = {
  en: {
    ...
    restore: {
      ...
      select: 'browse',
      streamHint: 'Or receive a backup streamed from another server (no manual upload).',
      streamListen: 'Ready to receive stream',
      streamWaiting: 'Waiting for source… token:',
  ...
  fa: {
    ...
    restore: {
      ...
      select: 'انتخاب کنید',
      streamHint: 'یا بکاپ را از سرور دیگر با استریم بگیرید (بدون آپلود دستی).',
      streamListen: 'آماده‌سازی دریافت استریم',
      streamWaiting: 'منتظر مبدأ… توکن:',
  ...
  ru: {
    ...
    restore: {
      ...
      select: 'выберите',
      streamHint: 'Или примите бэкап стримом с другого сервера (без ручной загрузки).',
      streamListen: 'Готов принимать стрим',
      streamWaiting: 'Ждём источник… токен:',
