...
const I18N = {
  en: {
    ...
    welcome: {
      ...
      betaWarning: 'Beta (v1.0beta): this public release is still experimental. Bugs are possible — use with caution.',
  ...
  fa: {
    ...
    welcome: {
      ...
      betaWarning: 'نسخه بتا (v1.0beta): این انتشار عمومی هنوز آزمایشی است. احتمال باگ هست — با احتیاط استفاده کنید.',
  ...
  ru: {
    ...
    welcome: {
      ...
      betaWarning: 'Бета (v1.0beta): этот публичный релиз ещё экспериментальный. Возможны ошибки — используйте осторожно.',
