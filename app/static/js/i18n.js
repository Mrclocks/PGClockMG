...
const I18N = {
  en: {
    ...
    welcome: {
      ...
      backupTip: 'Tip: changing the database type during restore is still experimental and may fail.',
      start: 'Start',
    },
    pg: {
      h2: 'PasarGuard setup',
      ...
      dbMatchTip: 'If you later change the database type during restore, that path is experimental and may hit issues.',
    ...
    restore: {
      ...
      targetHint: 'Changing DB type is experimental. Prefer the same engine as the backup.',
      experimentalBadge: 'Experimental',
      experimentalLabel: 'I understand DB change is experimental and may fail',
      needExperimental: 'Confirm the experimental checkbox to change database type',
  ...
  fa: {
    ...
    welcome: {
      ...
      backupTip: 'نکته: اگر موقع ریستور بخواهید نوع دیتابیس را عوض کنید، این قابلیت هنوز آزمایشی است و ممکن است به مشکل بخورد.',
      start: 'شروع',
    },
    pg: {
      ...
      dbMatchTip: 'اگر بعداً موقع ریستور نوع دیتابیس را عوض کنید، این مسیر آزمایشی است و ممکن است خطا بدهد.',
    ...
    restore: {
      ...
      targetHint: 'عوض کردن نوع دیتابیس آزمایشی است. بهتر است همان موتور بکاپ را نگه دارید.',
      experimentalBadge: 'آزمایشی',
      experimentalLabel: 'متوجه هستم که تغییر دیتابیس آزمایشی است و ممکن است ناموفق باشد',
