...
const I18N = {
  en: {
    ...
    stepsRestore: ['Welcome', 'Setup', 'Change DB', 'Run', 'Done'],
    stepsChangeDb: ['Welcome', 'Setup', 'Change DB', 'Run', 'Done'],
    ...
    welcome: {
      ...
      goalChangeDb: 'Change database',
      goalChangeDbDesc: 'Install/keep panel on a new DB, then restore & convert a backup',
      goalMigrate: 'Migrate from other panels',
      goalMigrateDesc: 'Marzban, 3x-ui, Remnawave, Hiddify, …',
      backupTip: 'For database change: install PasarGuard on the target engine, then restore the old backup — conversion runs automatically when possible.',
      start: 'Start',
    },
    pg: {
      h2: 'PasarGuard setup',
    ...
    restore: {
      ...
      h2ChangeDb: 'Change database',
      desc: 'Upload the backup zip. Destination DB is always the one already installed on this panel; conversion runs automatically when needed.',
      descChangeDb: 'Upload the backup from the old database. It will be restored and converted to the DB engine currently installed on this panel.',
      tip: 'Backup files are usually here:',
      ...
      restoring: 'Restoring…',
      runningTitle: 'Restore in progress',
      runningDesc: 'Do not close this page. Logs update live below.',
      ...
      autoConvertNote: 'Backup DB differs from the installed panel DB. After restore, data will be converted automatically to the installed database.',
  ...
  fa: {
    ...
    stepsRestore: ['خوش‌آمد', 'نصب', 'تغییر DB', 'اجرا', 'نتیجه'],
    stepsChangeDb: ['خوش‌آمد', 'نصب', 'تغییر DB', 'اجرا', 'نتیجه'],
    ...
    welcome: {
      ...
      goalChangeDb: 'تغییر دیتابیس',
      goalChangeDbDesc: 'نصب روی دیتابیس جدید، سپس ریستور و تبدیل بکاپ قدیمی',
      goalMigrate: 'مهاجرت از پنل‌های دیگر',
      goalMigrateDesc: 'Marzban، 3x-ui، Remnawave، Hiddify و …',
      backupTip: 'برای تغییر دیتابیس: اول PasarGuard را با موتور مقصد نصب کنید، بعد بکاپ قدیمی را ریستور کنید — تبدیل در صورت امکان خودکار است.',
      start: 'شروع',
    },
    pg: {
    ...
    restore: {
      ...
      h2ChangeDb: 'تغییر دیتابیس',
      desc: 'فایل zip بکاپ را آپلود کنید. دیتابیس مقصد همان دیتابیس نصب‌شده روی این پنل است؛ در صورت نیاز تبدیل به‌صورت خودکار انجام می‌شود.',
      descChangeDb: 'بکاپ دیتابیس قدیمی را آپلود کنید. ریستور و تبدیل خودکار به موتور دیتابیس فعلی پنل انجام می‌شود.',
      ...
      runningDesc: 'صفحه را نبندید. لاگ‌ها به‌صورت زنده پایین به‌روز می‌شوند.',
      ...
      autoConvertNote: 'دیتابیس بکاپ با دیتابیس نصب‌شده فرق دارد. بعد از ریستور، تبدیل خودکار به دیتابیس فعلی پنل انجام می‌شود.',
  ...
  ru: {
    ...
    stepsRestore: ['Старт', 'Установка', 'Смена БД', 'Запуск', 'Итог'],
    stepsChangeDb: ['Старт', 'Установка', 'Смена БД', 'Запуск', 'Итог'],
    ...
    welcome: {
      ...
      goalChangeDb: 'Смена базы данных',
      goalChangeDbDesc: 'Установка на новую СУБД, затем восстановление и конвертация бэкапа',
      goalMigrate: 'Миграция с других панелей',
      goalMigrateDesc: 'Marzban, 3x-ui, Remnawave, Hiddify, …',
      backupTip: 'Для смены БД: установите PasarGuard на целевую СУБД, затем восстановите старый бэкап — конвертация по возможности автоматическая.',
      start: 'Начать',
    },
    pg: {
    ...
    restore: {
      ...
      h2ChangeDb: 'Смена базы данных',
      desc: 'Загрузите zip. Целевая БД — установленная на панели; при необходимости конвертация выполняется автоматически.',
      descChangeDb: 'Загрузите бэкап со старой СУБД. Он будет восстановлен и конвертирован в текущую БД панели.',
      ...
      autoConvertNote: 'БД бэкапа отличается от установленной. После восстановления данные будут автоматически конвертированы.',
