...
const I18N = {
  en: {
    ...
    welcome: {
      ...
      betaWarning: 'Beta (v1.1beta): this public release is still experimental. Bugs are possible — use with caution.',
      backupWarning: 'Backup first: before any restore or migration, take a full backup of your panel, database, and important files.',
  ...
  fa: {
    ...
    welcome: {
      ...
      betaWarning: 'نسخه بتا (v1.1beta): این انتشار عمومی هنوز آزمایشی است. احتمال باگ هست — با احتیاط استفاده کنید.',
      backupWarning: 'اول بکاپ بگیرید: قبل از هر ریستور یا مهاجرت، از پنل، دیتابیس و فایل‌های مهم بکاپ کامل بگیرید.',
  ...
  ru: {
    ...
    welcome: {
      ...
      betaWarning: 'Бета (v1.1beta): этот публичный релиз ещё экспериментальный. Возможны ошибки — используйте осторожно.',
      backupWarning: 'Сначала бэкап: перед восстановлением или миграцией сделайте полный бэкап панели, БД и важных файлов.',
