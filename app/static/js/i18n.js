...
const I18N = {
  en: {
    ...
    finishModal: {
      ...
      cancel: 'Cancel',
      uninstall: 'Remove wizard & open panel',
      continue: 'Keep wizard & open panel',
    },
    steps: ['Welcome', 'Setup', 'Panel', 'Source', 'Target', 'Confirm', 'Run', 'Done'],
    stepsMigrate: ['Welcome', 'Setup', 'Panel', 'Source', 'Target', 'Confirm', 'Run', 'Done'],
    stepsRestore: ['Welcome', 'Setup', 'Restore / Change DB', 'Run', 'Done'],
    stepsChangeDb: ['Welcome', 'Setup', 'Restore / Change DB', 'Run', 'Done'],
    stepsInstall: ['Welcome', 'Install guide', 'Done'],
    ...
    welcome: {
      ...
      goalHint: 'PasarGuard must already be installed for restore or migrate. The Install tab shows official install commands.',
      goalInstall: 'Install PasarGuard',
      goalInstallDesc: 'Official install commands by database + create owner guide',
      ...
      backupTip: 'Install PasarGuard yourself with the database you need, then restore or migrate here.',
      start: 'Start',
    },
    pg: {
      h2: 'Install PasarGuard',
      desc: 'Official install commands and create-owner guide — run them yourself on the server.',
      installedTitle: 'PasarGuard is already installed',
      installedDetail: 'Found at /opt/pasarguard — you can continue.',
      continue: 'Continue with current DB →',
      back: '← Back',
      ...
      githubLink: 'GitHub',
      recheck: 'I installed it — Recheck',
    },
    needPg: {
      title: 'PasarGuard required',
      desc: 'PasarGuard must be installed on this server before you can restore or migrate.',
      cancel: 'Cancel',
      goInstall: 'Go to Install tab',
    },
    choose: {
      h2: 'What next?',
    ...
    step3: {
      ...
      pgMissingDesc: 'Install PasarGuard first via the Install tab, then return here and recheck.',
      pgInstallHint: 'Open the Install tab for official install commands by database.',
  ...
  fa: {
    ...
    steps: ['خوش‌آمد', 'نصب', 'پنل', 'مبدأ', 'مقصد', 'تأیید', 'اجرا', 'نتیجه'],
    stepsMigrate: ['خوش‌آمد', 'نصب', 'پنل', 'مبدأ', 'مقصد', 'تأیید', 'اجرا', 'نتیجه'],
    stepsRestore: ['خوش‌آمد', 'نصب', 'ریستور / تغییر DB', 'اجرا', 'نتیجه'],
    stepsChangeDb: ['خوش‌آمد', 'نصب', 'ریستور / تغییر DB', 'اجرا', 'نتیجه'],
    stepsInstall: ['خوش‌آمد', 'راهنمای نصب', 'پایان'],
    stepsSetup: ['خوش‌آمد', 'نصب', 'ادامه'],
    welcome: {
      h2: 'به MrClock-MG خوش آمدید',
      desc: 'می‌خواهید دقیقاً چه کاری انجام دهید؟',
      note: 'همه‌چیز روی سرور خودتان اجرا می‌شود؛ بکاپ، رمز و لاگ از سرور خارج نمی‌شوند.',
      goalHint: 'برای ریستور یا مهاجرت، PasarGuard باید از قبل نصب باشد. تب نصب دستورهای رسمی را نشان می‌دهد.',
      goalInstall: 'نصب PasarGuard',
      goalInstallDesc: 'دستورهای رسمی نصب بر اساس دیتابیس + راهنمای ساخت Owner',
      goalChangeDb: 'تغییر دیتابیس / ریستور بکاپ',
      goalChangeDbDesc: 'ریستور بکاپ پاسارگارد — با یا بدون تغییر موتور دیتابیس',
      goalMigrate: 'مهاجرت از پنل‌های دیگر',
      goalMigrateDesc: 'Marzban، 3x-ui، Remnawave، Hiddify و …',
      backupTip: 'ابتدا خودتان PasarGuard را با دیتابیس مورد نیاز نصب کنید، سپس اینجا ریستور یا مهاجرت کنید.',
      start: 'شروع',
    },
    pg: {
      h2: 'نصب PasarGuard',
      desc: 'دستورهای رسمی نصب و راهنمای ساخت Owner — خودتان روی سرور اجرا کنید.',
      installedTitle: 'PasarGuard از قبل نصب است',
      installedDetail: 'در /opt/pasarguard یافت شد — می‌توانید ادامه دهید.',
      continue: 'ادامه با دیتابیس فعلی →',
      back: '← بازگشت',
      guideIntro: 'یک دستور را کپی کنید، به‌عنوان root روی سرور اجرا کنید، سپس حساب Owner بسازید.',
      cmdsTitle: 'دستورهای نصب',
      cmdsHint: 'دیتابیس مورد نظر را انتخاب کنید. دستورها از نصب‌کننده رسمی PasarGuard هستند.',
      tutorialTitle: 'نحوه نصب',
      tutorialSteps: [
        'دستور نصب دیتابیس مورد نظر را انتخاب کنید',
        'آن را به‌عنوان root روی سرور اجرا کنید',
        'تا پایان نصب صبر کنید',
        'داشبورد را در دامنه:۸۰۰۰ باز کنید (یا از تونل SSH استفاده کنید)',
        'به بخش Owner access بروید',
        'دستور generate-temp-key را روی سرور اجرا کنید',
        'حساب Owner را در پنل بسازید',
      ],
      ownerKeyLabel: 'ساخت کلید موقت Owner',
      ownerKeyHint: 'بعد از نصب این دستور را روی سرور بزنید و کلید را در Owner access وارد کنید.',
      sshTunnelLabel: 'تونل SSH (اگر دسترسی عمومی ندارید)',
      sshTunnelHint: 'پورت ۸۰۰۰ لوکال را به سرور فوروارد کنید تا داشبورد باز شود.',
      docsLink: 'مستندات PasarGuard',
      githubLink: 'GitHub',
      recheck: 'نصب کردم — بررسی مجدد',
    },
    needPg: {
      title: 'PasarGuard لازم است',
      desc: 'قبل از ریستور یا مهاجرت، PasarGuard باید روی این سرور نصب باشد.',
      cancel: 'انصراف',
      goInstall: 'رفتن به تب نصب',
    },
    choose: {
      h2: 'بعدی چه کار کنیم؟',
    ...
    restore: {
      ...
      desc: 'زیپ بکاپ پاسارگارد را آپلود کنید. مقصد همان دیتابیس نصب‌شده است؛ در صورت تفاوت موتور، تبدیل خودکار انجام می‌شود.',
      descChangeDb: 'بکاپ پنل قبلی را آپلود کنید. ریستور و تبدیل به موتور فعلی (یا تازه نصب‌شده) انجام می‌شود.',
      ...
      runningTitle: 'در حال ریستور بکاپ',
      runningDesc: 'صفحه را نبندید. لاگ‌ها پایین به‌روز می‌شوند.',
      doneTitle: 'ریستور با موفقیت انجام شد',
      ...
      autoConvertNote: 'SQLite می‌تواند به هر دیتابیسی تبدیل شود. دیتابیس‌های دیگر به SQLite تبدیل نمی‌شوند. موتورهای دیگر به هم تبدیل می‌شوند. ریستور هم‌موتور از رمز دیتابیس بکاپ در .env جدید استفاده می‌کند.',
    ...
    step3: {
      ...
      pgMissingDesc: 'ابتدا از تب نصب، PasarGuard را نصب کنید، سپس برگردید و بررسی مجدد بزنید.',
      pgInstallHint: 'برای دستورهای رسمی نصب بر اساس دیتابیس، تب نصب را باز کنید.',
  ...
  ru: {
    ...
    steps: ['Старт', 'Установка', 'Панель', 'Источник', 'Цель', 'Проверка', 'Запуск', 'Итог'],
    stepsMigrate: ['Старт', 'Установка', 'Панель', 'Источник', 'Цель', 'Проверка', 'Запуск', 'Итог'],
    stepsRestore: ['Старт', 'Установка', 'Восстановление / смена БД', 'Запуск', 'Итог'],
    stepsChangeDb: ['Старт', 'Установка', 'Восстановление / смена БД', 'Запуск', 'Итог'],
    stepsInstall: ['Старт', 'Гид по установке', 'Готово'],
    ...
    welcome: {
      ...
      goalHint: 'Для восстановления или миграции PasarGuard уже должен быть установлен. Вкладка Install показывает официальные команды.',
      goalInstall: 'Установить PasarGuard',
      goalInstallDesc: 'Официальные команды установки по БД + гайд создания Owner',
      ...
      goalMigrateDesc: 'Marzban, 3x-ui, Remnawave, Hiddify, …',
      backupTip: 'Сначала установите PasarGuard сами с нужной БД, затем восстанавливайте или мигрируйте здесь.',
      start: 'Начать',
    },
    pg: {
      h2: 'Установка PasarGuard',
      desc: 'Официальные команды установки и гайд создания Owner — выполните их сами на сервере.',
      installedTitle: 'PasarGuard уже установлен',
      installedDetail: 'Найден в /opt/pasarguard — можно продолжить.',
      continue: 'Продолжить с текущей БД →',
      back: '← Назад',
    ...
    needPg: {
      ...
      desc: 'Перед восстановлением или миграцией PasarGuard должен быть установлен на этом сервере.',
      cancel: 'Отмена',
      goInstall: 'К вкладке Install',
    },
    choose: {
      h2: 'Что дальше?',
    ...
    step3: {
      ...
      pgMissingDesc: 'Сначала установите PasarGuard через вкладку Install, затем вернитесь и проверьте снова.',
      pgInstallHint: 'Откройте вкладку Install для официальных команд установки по БД.',
