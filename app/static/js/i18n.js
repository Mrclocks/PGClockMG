...
const I18N = {
  en: {
    ...
    step3: {
      ...
      crossDbWarning: 'Cross-database migration: Marzban source is {source}, PasarGuard uses {target}. Data will be converted with official db-migrations.',
  ...
  fa: {
    ...
    step3: {
      ...
      crossDbWarning: 'مهاجرت بین دیتابیس‌های مختلف: مبدأ Marzban از {source} و PasarGuard از {target}. تبدیل با db-migrations رسمی انجام می‌شود.',
  ...
  ru: {
    ...
    step3: {
      ...
      crossDbWarning: 'Миграция между разными БД: Marzban — {source}, PasarGuard — {target}. Конвертация через официальный db-migrations.',
