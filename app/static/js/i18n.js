...
const I18N = {
  en: {
    ...
    stepsInstall: ['Welcome', 'Setup', 'Done'],
    ...
    welcome: {
      ...
      goalHint: 'Choose one path — if PasarGuard is missing, the wizard installs it first, then continues.',
      goalInstall: 'Install new PasarGuard',
      goalInstallDesc: 'Fresh install, then open the panel',
      ...
      backupTip: 'Change DB and restore are one flow: set the target engine (install if needed), then upload the backup zip.',
      start: 'Start',
    },
    pg: {
      h2: 'PasarGuard setup',
      ...
      reinstallOther: 'Reinstall with a different database',
      back: '← Back',
      ...
      dbMatchTip: 'Pick any database to install. If your backup uses another engine, restore it next — conversion runs automatically when possible.',
      dbMatchTipChange: 'Pick the NEW database engine you want. After install, upload the old backup — data converts to this engine automatically.',
    ...
    restore: {
      ...
      autoConvertNote: 'If the backup DB differs from the installed DB, data is converted automatically. Success requires real row counts — env/certs alone are not enough.',
  ...
  fa: {
    ...
    stepsInstall: ['خوش‌آمد', 'نصب', 'پایان'],
    ...
    welcome: {
      ...
      goalHint: 'یک مسیر را انتخاب کنید — اگر PasarGuard نصب نباشد، اول نصب می‌شود و بعد همان مسیر ادامه پیدا می‌کند.',
      goalInstall: 'نصب پاسارگارد جدید',
      goalInstallDesc: 'نصب تازه و ورود به پنل',
      ...
      backupTip: 'تغییر دیتابیس و ریستور یک مسیر است: موتور مقصد را مشخص کنید (در صورت نیاز نصب)، بعد زیپ بکاپ را آپلود کنید.',
      start: 'شروع',
    },
    pg: {
      h2: 'راه‌اندازی PasarGuard',
      desc: 'اگر نصب است ادامه دهید؛ اگر نه، همین‌جا خودکار نصب می‌شود.',
      ...
      reinstallOther: 'نصب مجدد با دیتابیس دیگر',
      back: '← بازگشت',
      ...
      dbMatchTip: 'هر دیتابیسی برای نصب انتخاب کنید. اگر بکاپ موتور دیگری دارد، در مرحله ریستور آپلود کنید تا در صورت امکان خودکار تبدیل شود.',
      dbMatchTipChange: 'دیتابیس جدید (مقصد) را انتخاب کنید. بعد از نصب، بکاپ قدیمی را آپلود کنید تا داده به‌صورت خودکار به همین موتور تبدیل شود.',
    ...
    restore: {
      ...
      autoConvertNote: 'اگر موتور بکاپ با نصب فرق دارد، تبدیل خودکار انجام می‌شود. موفقیت یعنی انتقال واقعی کاربران/هاست‌ها — فقط env و cert کافی نیست.',
  ...
  ru: {
    ...
    stepsInstall: ['Старт', 'Установка', 'Готово'],
    ...
    welcome: {
      ...
      goalHint: 'Выберите путь — если PasarGuard нет, мастер сначала установит его, затем продолжит.',
      goalInstall: 'Новая установка PasarGuard',
      goalInstallDesc: 'Чистая установка и вход в панель',
      ...
      goalMigrateDesc: 'Marzban, 3x-ui, Remnawave, Hiddify, …',
      backupTip: 'Смена БД и восстановление — один путь: выберите целевую СУБД (установите при необходимости), затем загрузите zip бэкапа.',
      start: 'Начать',
    },
    pg: {
      ...
      reinstallOther: 'Переустановить с другой БД',
      back: '← Назад',
      ...
      dbMatchTip: 'Выберите любую СУБД. Если бэкап на другой — восстановите его далее; конвертация по возможности автоматическая.',
      dbMatchTipChange: 'Выберите НОВУЮ СУБД. После установки загрузите старый бэкап — данные конвертируются автоматически.',
    ...
    restore: {
      ...
      autoConvertNote: 'При отличии СУБД данные конвертируются автоматически. Успех = реальные строки users/hosts — одного .env/certs недостаточно.',
