...
const I18N = {
  en: {
    ...
    stepsRestore: ['Welcome', 'Setup', 'Next', 'Backup', 'Run', 'Done'],
    ...
    welcome: {
      ...
      backupTip: 'You can install PasarGuard on a new database now, then restore an old backup — the wizard converts databases automatically when possible.',
      start: 'Start',
    },
    pg: {
      h2: 'PasarGuard setup',
  ...
  fa: {
    ...
    stepsRestore: ['خوش‌آمد', 'نصب', 'ادامه', 'بکاپ', 'اجرا', 'نتیجه'],
    stepsSetup: ['خوش‌آمد', 'نصب', 'ادامه'],
    welcome: {
      h2: 'به MrClock-MG خوش آمدید',
      desc: 'نصب PasarGuard، ریستور بکاپ و مهاجرت از پنل‌های دیگر — ساده و روی همین سرور.',
      note: 'همه‌چیز روی سرور خودتان اجرا می‌شود؛ بکاپ، رمز و لاگ از سرور خارج نمی‌شوند.',
      backupTip: 'می‌توانید الان PasarGuard را با دیتابیس جدید نصب کنید و بعد بکاپ قدیمی را ریستور کنید — تبدیل دیتابیس در صورت امکان خودکار انجام می‌شود.',
      start: 'شروع',
    },
    pg: {
  ...
  ru: {
    ...
    stepsRestore: ['Старт', 'Установка', 'Далее', 'Бэкап', 'Запуск', 'Итог'],
    ...
    welcome: {
      ...
      backupTip: 'Можно установить PasarGuard на новую БД, затем восстановить старый бэкап — мастер по возможности конвертирует СУБД автоматически.',
      start: 'Начать',
    },
    pg: {
