...
const I18N = {
  en: {
    ...
    copyManual: {
      title: 'Copy manually',
      body: 'Select the text below and copy it.',
    },
    finishModal: {
      title: 'Open panel?',
    ...
    choose: {
      ...
      migrateDesc: 'Marzban, 3x-ui, Hiddify, …',
      back: '← Back',
    },
    restore: {
      ...
      select: 'browse',
      streamHint: 'Receive a backup from another server’s backup panel (no manual zip upload).',
      streamListen: 'Ready to receive stream',
      streamWaiting: 'Listening — waiting for source to connect…',
      streamReceiving: 'Receiving stream…',
      streamReady: 'Backup received — review below, then confirm restore.',
      streamError: 'Stream failed',
      streamIdle: 'Idle',
      streamListening: 'Listening',
      streamConnected: 'Receiving',
      streamStep1: 'Click Ready to receive stream to create a one-time token (~30 min).',
      streamStep2: 'On the source backup panel: open Stream, paste this wizard URL + token, then send.',
      streamStep3: 'Watch progress here; when ready, confirm restore below.',
      streamUrlHint: 'Suggested wizard URL (copy with token if shown).',
      streamPairHint: 'URL + token (paste both into the source Stream form).',
      autoRestoreOnStream: 'Auto-restore when stream finishes',
      autoRestoreOnStreamHint: 'If analysis is OK, start restore automatically. Uncheck to review first.',
      confirm: 'Confirm & start restore',
      back: '← Back',
      cancel: '← Cancel',
      hideProgress: 'Hide progress',
      runningBackHint: 'Restore is still running on the server. Leaving this page will not stop it. Continue?',
    ...
    step2: {
      ...
      resourceRefresh: 'Refresh server info',
      resourceActionWeak: 'Recommended: keep uploads comfortably below {maxUpload} to avoid long hangs.',
      resourceActionNormal: 'Recommended: server looks ready for standard uploads (limit {maxUpload}).',
      resourceActionStrong: 'Recommended: you have extra headroom (limit {maxUpload}).',
      resourceOverrideEnabledNote: 'override enabled',
      resourceOverrideDisabledNote: 'secure mode',
      resourceReason: {
    ...
    step5: {
      hideProgress: 'Hide progress',
      hideProgressHint: 'The migration keeps running on the server; this only hides progress. Continue?',
      h2: 'Migrating...',
      preparing: 'Preparing...',
    },
    step6: {
  ...
  fa: {
    ...
    copyManual: {
      title: 'کپی دستی',
      body: 'متن زیر را انتخاب کنید و کپی کنید.',
    },
    finishModal: {
      title: 'ورود به پنل؟',
    ...
    choose: {
      ...
      migrateDesc: 'Marzban، 3x-ui، Hiddify و …',
      back: '← بازگشت',
    },
    restore: {
      ...
      select: 'انتخاب کنید',
      streamHint: 'بکاپ را از پنل بکاپ سرور دیگر بگیرید (بدون آپلود دستی zip).',
      streamListen: 'آماده‌سازی دریافت استریم',
      streamWaiting: 'در حال گوش دادن — منتظر اتصال مبدأ…',
      streamReceiving: 'در حال دریافت استریم…',
      streamReady: 'بکاپ رسید — پایین را بررسی کنید و ریستور را تأیید کنید.',
      streamError: 'استریم ناموفق بود',
      streamIdle: 'آماده',
      streamListening: 'در حال گوش دادن',
      streamConnected: 'در حال دریافت',
      streamStep1: '«آماده‌سازی دریافت استریم» را بزنید تا توکن یک‌بارمصرف (~۳۰ دقیقه) ساخته شود.',
      streamStep2: 'روی پنل بکاپ مبدأ: استریم را باز کنید، آدرس همین ویزارد + توکن را بزنید و ارسال کنید.',
      streamStep3: 'پیشرفت را اینجا ببینید؛ بعد از رسیدن، ریستور را پایین تأیید کنید.',
      streamUrlHint: 'آدرس پیشنهادی ویزارد (در صورت نمایش با توکن کپی کنید).',
      streamPairHint: 'آدرس + توکن (هر دو را در فرم استریم مبدأ بچسبانید).',
      autoRestoreOnStream: 'ریستور خودکار بعد از رسیدن استریم',
      autoRestoreOnStreamHint: 'اگر آنالیز OK بود، ریستور خودکار شروع می‌شود. برای بررسی دستی خاموش کنید.',
      confirm: 'تأیید و شروع ریستور',
      back: '← بازگشت',
      cancel: '← انصراف',
      hideProgress: 'مخفی کردن پیشرفت',
      runningBackHint: 'ریستور روی سرور هنوز در حال اجراست و با ترک صفحه قطع نمی‌شود. ادامه می‌دهید؟',
    ...
    step2: {
      ...
      resourceRefresh: 'تازه‌سازی اطلاعات سرور',
      resourceActionWeak: 'اقدام پیشنهادی: برای جلوگیری از گیر کردن، آپلود را با فاصله امن زیر {maxUpload} نگه دارید.',
      resourceActionNormal: 'اقدام پیشنهادی: سرور برای آپلودهای معمول آماده است (سقف {maxUpload}).',
      resourceActionStrong: 'اقدام پیشنهادی: فضای بهتر دارید (سقف آپلود {maxUpload}).',
      resourceOverrideEnabledNote: 'override فعال',
      resourceOverrideDisabledNote: 'حالت امن',
      resourceReason: {
    ...
    step5: {
      hideProgress: 'مخفی کردن پیشرفت',
      hideProgressHint: 'مهاجرت روی سرور ادامه دارد؛ فقط نمایش پیشرفت مخفی می‌شود. ادامه؟',
      h2: 'در حال مهاجرت...',
  ...
  ru: {
    ...
    copyManual: {
      ...
      body: 'Выделите текст ниже и скопируйте.',
    },
    finishModal: {
    ...
    restore: {
      ...
      select: 'выберите',
      streamHint: 'Примите бэкап с панели бэкапа другого сервера (без ручной загрузки zip).',
      streamListen: 'Готов принимать стрим',
      streamWaiting: 'Слушаем — ждём подключения источника…',
      streamReceiving: 'Идёт приём стрима…',
      streamReady: 'Бэкап получен — проверьте ниже и подтвердите восстановление.',
      streamError: 'Стрим не удался',
      streamIdle: 'Готово',
      streamListening: 'Слушаем',
      streamConnected: 'Приём',
      streamStep1: 'Нажмите «Готов принимать стрим», чтобы создать одноразовый токен (~30 мин).',
      streamStep2: 'На панели бэкапа источника: Stream → URL этого мастера + токен → отправить.',
      streamStep3: 'Следите за прогрессом здесь; затем подтвердите restore ниже.',
      streamUrlHint: 'Предлагаемый URL мастера (копируйте вместе с токеном).',
      streamPairHint: 'URL + токен (вставьте оба в форму Stream на источнике).',
      autoRestoreOnStream: 'Авто-restore после стрима',
      autoRestoreOnStreamHint: 'Если анализ OK — restore стартует сам. Снимите галочку для ручной проверки.',
      confirm: 'Подтвердить и восстановить',
      back: '← Назад',
      cancel: '← Отмена',
      hideProgress: 'Скрыть прогресс',
      runningBackHint: 'Восстановление всё ещё выполняется на сервере. Уход со страницы его не остановит. Продолжить?',
    ...
    step2: {
      ...
      resourceRefresh: 'Обновить данные сервера',
      resourceActionWeak: 'Рекомендация: чтобы избежать зависаний, держите загрузки заметно ниже {maxUpload}.',
      resourceActionNormal: 'Рекомендация: сервер готов для обычных копий (лимит {maxUpload}).',
      resourceActionStrong: 'Рекомендация: есть запас (лимит {maxUpload}).',
      resourceOverrideEnabledNote: 'override включён',
      resourceOverrideDisabledNote: 'защищённый режим',
      resourceReason: {
    ...
    step5: {
      hideProgress: 'Скрыть прогресс',
      hideProgressHint: 'Миграция продолжается на сервере; скрывается только прогресс. Продолжить?',
      h2: 'Миграция...',
