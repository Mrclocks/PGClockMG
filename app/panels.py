    ...
    "hiddify": PanelInfo(
        ...
        warnings={
            "en": [
                ...
                "Previous user links keep working via pg-redirect on port 443 (and Hiddify tls_ports).",
                "Uses Hiddify SSL certs from /opt/hiddify-manager/ssl when present so old domains keep working.",
            ...
            "fa": [
                ...
                "لینک‌های قبلی کاربران با pg-redirect روی پورت 443 (و tls_ports هیدیفای) کار می‌کنند.",
                "اگر موجود باشد از سرتیفیکیت‌های /opt/hiddify-manager/ssl استفاده می‌شود تا دامنه قدیمی بماند.",
            ...
            "ru": [
                ...
                "Старые ссылки работают через pg-redirect на 443 (и tls_ports Hiddify).",
                "При наличии берутся сертификаты /opt/hiddify-manager/ssl для старых доменов.",
